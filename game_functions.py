...
def check_events(ai_settings, screen, stats, play_button, ship, aliens, bullets): #相应按键和鼠标
...
def update_screen(ai_settings, screen, stats, sb, ship, aliens, bullets, play_button): #更新屏幕上的图像，并切换到新屏幕
    ...
    if not stats.game_active: #如果处于非活动状态，就绘制Play按钮
        play_button.draw_button()

    pygame.display.flip() #让最近绘制的屏幕可见

def update_bullets(ai_settings, screen, stats, sb, ship, aliens, bullets): #更新子弹
    bullets.update()
